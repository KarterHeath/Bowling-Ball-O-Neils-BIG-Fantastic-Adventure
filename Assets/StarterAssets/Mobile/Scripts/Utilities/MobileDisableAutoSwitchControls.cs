...
#if (UNITY_IOS || UNITY_ANDROID) // CHecks if on IOS or Android
   //Mobile - Do nothing
    
#else  // NotMobile - Destroy OnScreen Controls
    private void Start()
    {
        Destroy(gameObject);//Destroy UI Canvas for OnScreen Controls
    }
